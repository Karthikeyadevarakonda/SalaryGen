...
const App = () => {
  ...
  return (
    <div
      className={`min-h-screen ${colors.primary} ${colors.text} flex flex-col transition-colors duration-300`}
    >
      <header
        className={`${colors.secondary} ${colors.border} border-b transition-colors duration-300`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <h1
            className={`text-xl sm:text-2xl font-bold ${colors.text} gap-2 flex items-center`}
          >
            <FaArtstation className={colors.textSecondary} /> SalaryGen
          </h1>

          <nav
            className={`hidden md:flex items-center space-x-4 lg:space-x-6 text-sm ${colors.textSecondary}`}
          >
            <Link
              to="/features"
              className={`italic font-semibold hover:${
        ...
        >
          <div
            className={`px-6 py-4 space-y-4 text-sm ${colors.textSecondary}`}
          >
            <Link
              to="/features"
      ...
      <main className="flex flex-1 flex-col lg:flex-row items-center justify-between px-6 sm:px-10 py-10 sm:py-20 gap-8 sm:gap-10">
        ...
        >
          <h2
            className={`text-3xl sm:text-4xl font-bold ${colors.text} leading-snug`}
          >
          ...
          <p className={`mt-4 ${colors.textMuted} text-base sm:text-lg`}>
            Automate payroll, visualize deductions, and generate clean reports
            in seconds.
          </p>
          <div className="mt-6 flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0">
            ...
            <Link
              ...
              } border px-6 py-3 rounded ${colors.hover} transition-colors`}
            >
              Watch Demo
            </Link>
          </div>
        ...
        >
          ...
          <svg
            ...
            className={`w-full h-32 ${
              colors.accent.includes("teal") ? "text-teal-400" : "text-blue-500"
            }`}
          >
            <motion.path
              d={pathD}
          ...
          <div
            className={`flex justify-between text-xs ${colors.textMuted} mt-2`}
          >
            <span>Week 1</span>
            <span>Week 2</span>
            <span>Week 3</span>
          ...
          <div
            className={`mt-4 flex items-center gap-2 text-xs ${colors.textMuted}`}
          >
            <div
              className={`w-2 h-2 ${
                colors.accent.includes("teal") ? "bg-teal-400" : "bg-blue-500"
      ...
      <footer
        className={`text-center text-xs sm:text-sm ${colors.textMuted} py-4 ${colors.border} border-t transition-colors duration-300`}
      >
