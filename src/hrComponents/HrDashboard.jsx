...
const HrDashboard = () => {
  ...
  const menuItems = [
    ...
    {
      path: "/hrDashboard/salaryComponents",
      label: "Salary Components",
      icon: <FiSettings />,
    },
    {
      path: "/hrDashboard/generateSalaries",
  ...
  return (
    <div
      className={`min-h-screen ${colors.primary} ${colors.text} flex transition-colors duration-300`}
    >
      {/* Mobile header */}
      <div
