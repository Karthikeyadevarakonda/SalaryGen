...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    {
      path: "/adminDashboard/salaryComponents",
      label: "Salary Components",
      icon: <FiSettings />,
    },
    {
      path: "/adminDashboard/generateSalaries",
  ...
  return (
    <div
      className={`h-fit ${colors.primary} ${colors.text} flex transition-colors duration-300`}
    >
      <div
        className={`fixed top-0 left-0 right-0 ${colors.secondary} ${colors.border} border-b p-4 flex items-center justify-between md:hidden z-50 transition-colors duration-300`}
      >
        <button
      ...
      <aside
        ...
        } md:translate-x-0 ${colors.secondary} ${colors.border} border-r`}
      >
        <div>
          <div
    ...
    ${
      isDarkMode
        ...
        : "border-slate-300 text-gray-600"
          ...
          >
            <FaUserCog
              className={isDarkMode ? "text-teal-300" : "text-blue-400"}
            />
            Admin Panel
          </div>
